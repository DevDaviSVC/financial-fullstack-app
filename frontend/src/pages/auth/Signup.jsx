...
export default function Signup() {
  ...
  return (
    <div className='text-center'>
        ...
        <form onSubmit={handleSubmit} className='bg-gray-950 rounded-xl bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-50 p-8 max-w-[600px] mx-auto my-10 text-start shadow-xl '>
